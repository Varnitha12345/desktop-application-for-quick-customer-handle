 ...
 * @author Asus
 */
public class PackingP extends javax.swing.JDialog {
     ...
     */
    public PackingP(gui.SyzygyFoodCorner parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel37.setText("(Order packing...)");

        jButton1.setText("Start Packing");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            for (int i = 0; i <= 100; i++) {
                ...
                jLabel37.setText(Integer.toString(i) + "% (Order packing...)");
            }
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PackingP packingP = new PackingP(new gui.SyzygyFoodCorner(), true);

                packingP.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
                    }
                });
                packingP.setVisible(true);
